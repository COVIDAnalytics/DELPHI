...
from DELPHI_utils_V5_static import DELPHIDataCreator, DELPHIDataSaver, get_initial_conditions, compute_mape, create_fitting_data_from_validcases, get_mape_data_fitting, DELPHIAggregations
from DELPHI_utils_V5_dynamic import (
...
if OPTIMIZER == "tnc":
    subname_parameters_file = "Global_V5"
elif OPTIMIZER == "annealing":
    subname_parameters_file = "Global_V5_annealing"
elif OPTIMIZER == "trust-constr":
    subname_parameters_file = "Global_V5_trust"
else:
