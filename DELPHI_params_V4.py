...
default_maxT = datetime(2021, 10, 10)  # Maximum timespan of prediction
...
default_maxT_policies = datetime(2021, 10, 10) # Maximum timespan of prediction under different policy scenarios
