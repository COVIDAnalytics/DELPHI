...
from DELPHI_utils_CT_dynamic import make_increasing
...
class DELPHIDataSaver:
    ...
    def save_all_datasets(
        ...
        if optimizer == "tnc":
            subname_file = "Global_CT"
        elif optimizer == "annealing":
            subname_file = "Global_CT_annealing"
        elif optimizer == "trust-constr":
            subname_file = "Global_CT_trust"
        else:
        ...
        df_parameters = pd.DataFrame(
            {
                ...
                "Percentage Hospitalized": [self.best_params[12]],
                "Duration of Hospitalized Stay": [self.best_params[13]],
            }
        )
...
def get_initial_conditions(params_fitted: tuple, global_params_fixed: tuple) -> list:
    ...
    """
    alpha, days, r_s, r_dth, p_dth, r_dthdecay, k1, k2, jump, t_jump, std_normal, k3, p_h, t_rh = params_fitted 
    N, R_upperbound, R_heuristic, R_0, PopulationD, PopulationI, p_d, p_v = global_params_fixed
