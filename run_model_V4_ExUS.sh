...
python DELPHI_model_V3_predict_additional_state.py -d "2020-07-01" -t 'ExUS' -g 'false' -dt '012421'

python DELPHI_model_V4_additional_states.py -rc run_configs/annealing-run-config.yml -t 'ExUS' -g 'false' -d '012421'
...
git add data_sandbox/predicted/parameters/* ;git add data_sandbox/predicted/policy_scenario_predictions/* ;git add logs/*
