...
def run_model_secondwave_with_policies(PATH_TO_FOLDER_DANGER_MAP, PATH_TO_DATA_SANDBOX, current_time, list_tuples,upload_to_s3):
    ...
    pastparameters = pd.read_csv(PATH_TO_FOLDER_DANGER_MAP + f"predicted/Parameters_Global_V2_annealing_{today}.csv")
    ...
    obj_value = 0
    for continent, country, province in list_tuples:
        ...
        if (
            ...
            if len(validcases) > validcases_threshold_policy:
                ...
                future_policies_data = future_policies_JJ
                future_times_data = future_times_JJ
