...
for continent, country, province in zip(
    ...
    if os.path.exists(PATH_TO_FOLDER_DANGER_MAP + f"processed/Global/Cases_{country_sub}_{province_sub}.csv") and country == "Germany":
        ...
        if len(validcases) > 7:
            ...
            maxT = (datetime(2020, 8, 15) - date_day_since100).days + 1
