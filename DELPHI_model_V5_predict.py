...
from DELPHI_utils_V5_dynamic import create_vaccinations_timeseries
...
def predict_area(
    ...
    """
    Parallelizable version of the solving process for DELPHI V5, this function is called with multiprocessing
...
if __name__ == "__main__":
    ...
    logger_filename = (
            ...
            f"model_fitting/delphi_model_V5_predict_{yesterday_logs_filename}.log"
    )
    logging.basicConfig(
    ...
    if full_raw:
        ...
        df_global_raw_since_today.to_csv(PATH_TO_DATA_SANDBOX + f'predicted/raw_predictions/Predicted_full_raw_V5_{today_date_str}.csv', index=False)
        df_global_raw_since_100_cases.to_csv(PATH_TO_DATA_SANDBOX + f'predicted/raw_predictions/Predicted_full_raw_V5_since100_{today_date_str}.csv', index=False)
    else:
        ...
        df_predicted_states.to_csv(PATH_TO_DATA_SANDBOX + f'predicted/raw_predictions/Predicted_model_state_V5_{fitting_start_date}.csv', index=False)